...
fun EditBikePartScreen(
    ...
    LaunchedEffect(bikePart) {
        if (bikePart != null && !isInitialized) {
            name = bikePart!!.name
            description = bikePart!!.description
            selectedCategory = bikePart!!.category
            quantity = bikePart!!.quantity.toString()
            minimalStock = bikePart!!.minimalStock.toString()
            price = bikePart!!.price.toString()
            manufacturer = bikePart!!.manufacturer ?: ""
            serialNumber = bikePart!!.serialNumber ?: ""
            isInitialized = true
        }
    }
                    ...
                    IconButton(
                        onClick = {
                            if (name.isBlank() || selectedCategory.isBlank()) {
                                ...
                                bikePart?.let { original ->
                                    val updatedPart = original.copy(
                                        name = name.trim(),
